...
switch function_name
   ...
   case 'reorient_lsp_to_sphinx_scanner_ffp'
    ...
    case 'preproc_mean_mask_mmds_check'
        %requires:
        %params.image_no = 1
        %creates:
        %params.mean_image = '/path/to/mean_image.nii';
        ...
        %params.dilate = '/path/to/dilated_mask.nii';
        %params.dilate_smooth = '/path/to/dilated_smooth_mask.nii';
        preproc_function.function_call = @preproc_mean_mask_mmds_check;
        preproc_function.function_name = 'preproc_mean_mask_mmds_check';
        preproc_function.function_description = 'generates a mean image mask of mean image masked mean image dilate mask and smooth mask -> check mask and reiterate if necess';
        preproc_function.prefix = '';
        preproc_function.is_directory_created = 0;
        preproc_function.is_regressor_created = 0;
        preproc_function.is_each_image_processed = 0;      
