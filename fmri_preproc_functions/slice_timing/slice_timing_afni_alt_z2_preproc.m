...
unix_command_call = sprintf('3dTshift -tzero 1 -tpattern alt+z2 -quintic -prefix %s %s >out.log', afni_base_name, input_file);
...
unix_command_call = sprintf('mri_convert -i %s -o %s >out.log', afni_full_name_BRIK, output_file);
system(unix_command_call)
