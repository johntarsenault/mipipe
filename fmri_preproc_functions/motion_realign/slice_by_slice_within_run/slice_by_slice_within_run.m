...
[print_name_image, print_name_matfile] = mc_undist_wouter_dante3_preproc([input_path, '/'], [input_file, input_ext], output_file, params);
...
regressor_name = [print_name_matfile];